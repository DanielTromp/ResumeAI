...
from config import AI_MODEL, EMBEDDING_MODEL, OPENAI_API_KEY
from config import SUPABASE_URL, SUPABASE_KEY
from config import NOCODB_TOKEN, NOCODB_PROJECT, NOCODB_TABLE
from config import URL1_SPINWEB_USER, URL1_SPINWEB_PASS
from config import URL1_PROVIDER_NAME, URL1_LOGIN_URL, URL1_SOURCE
from config import EXCLUDED_CLIENTS, MATCH_THRESHOLD, MATCH_COUNT
from config import RESUME_RPC_FUNCTION_NAME
