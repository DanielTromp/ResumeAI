...
def evaluate_candidate(name: str, cv_text: str, vacancy_text: str) -> tuple[dict, dict]:
    ...
    prompt = f"""
Je bent een AI die helpt bij het evalueren van CV's voor vacatures.
...
Evalueer objectief op basis van de volgende criteria:
1. Relevante werkervaring
2. Technische vaardigheden en kennis
3. Opleiding en certificeringen
4. Zachte vaardigheden en competenties
